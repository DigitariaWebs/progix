              ...
              <div className="relative overflow-hidden">
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-600">
                    Découvrez toutes les fonctionnalités du CRM FAHE
                  </p>
                </div>
...
>>>>>>> 3df5637086655d914f98828fafa99f17c2022e6a
                            </div>
                          </div>
                        </Card>
                      ))}
...
=======
                  ...
                  <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-3">
                    {section.images.map((_, idx) => (
                      <div
                        key={idx}
                        className="w-3 h-3 bg-white/50 rounded-full hover:bg-white transition-all duration-300 cursor-pointer animate-pulse"
                      ></div>
                    ))}
                  </div>
