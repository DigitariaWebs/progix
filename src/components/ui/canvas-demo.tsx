...
import { Zap, Target, Shield, Lightbulb, Users, TrendingUp } from "lucide-react";

function DemoWithCards() {
  return (
    <>
      <div className="py-20 flex flex-col lg:flex-row items-center justify-center bg-white dark:bg-black w-full gap-4 mx-auto px-8">
        <Card title="Excellence Technique" icon={<Zap className="h-10 w-10" />}>
          <CanvasRevealEffect
            animationSpeed={5.1}
            containerClassName="bg-emerald-900"
          />
        </Card>
        <Card title="Innovation Continue" icon={<Lightbulb className="h-10 w-10" />}>
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card title="Solutions Sur Mesure" icon={<Target className="h-10 w-10" />}>
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <div className="border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2]  max-w-sm w-full mx-auto p-4 relative h-[30rem]">
          ...
          <div className="relative z-20">
            <div className="text-center group-hover/canvas-card:-translate-y-4 group-hover/canvas-card:opacity-0 transition duration-200 w-full  mx-auto flex items-center justify-center">
              <Shield className="h-10 w-10 text-black dark:text-white group-hover/canvas-card:text-white" />
            </div>
